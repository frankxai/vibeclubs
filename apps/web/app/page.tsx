...
import { AuroraBg } from '@/components/patterns/aurora-bg'
          ...
          <div className="grid lg:grid-cols-[1.3fr_1fr] gap-16 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-white/70 max-w-xl leading-relaxed mb-10">
                Claude Code + your crew + a soundtrack. Lock in for 90 minutes. Ship the thing. Recap
                lands on your profile when you&apos;re done.
              </p>
              <div className="flex flex-wrap items-center gap-3">
                <LinkButton href="/start" variant="primary" size="xl">
                  Host a vibeclub →
                </LinkButton>
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-12">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight leading-tight mt-4">
                Not a meeting.<br />Not a study timer.
              </h2>
            </div>
            <div className="text-lg text-white/70 leading-relaxed space-y-4 pt-4 max-w-2xl">
              ...
              <p>
                Everyone in the club shares the soundtrack and hits the same pomodoro. Claude keeps
                quiet notes on the side. When the session ends, you get a card. You post the card.
                Next Sunday, three more people show up.
              </p>
          ...
          <div className="grid md:grid-cols-[2fr_1fr] gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-3 text-sm text-white/50">
                <Badge tone="outline" size="xs">Opt-in</Badge>
                <span>·</span>
          ...
          <div className="flex items-end justify-between mb-12 flex-wrap gap-6">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mt-4">
                Pick a template.<br />Host in 60 seconds.
              </h2>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-3">
            {CLUB_TEMPLATES.slice(0, 6).map((t) => (
              <Link
                ...
                className="group rounded-2xl border border-white/10 bg-white/[0.02] hover:border-amber-400/30 hover:bg-white/[0.04] transition p-5 flex items-start gap-3"
              >
